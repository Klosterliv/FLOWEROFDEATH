        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                void displacement (inout VertexInput v){
                    ...
                    float2 node_2955 = float2(mul(_Object2World, v.vertex).r,mul(_Object2World, v.vertex).g);
...
////// Emissive:
                float2 node_2955 = float2(i.posWorld.r,i.posWorld.g);
                float2 node_5016 = saturate((float2(_PlayerPos.r,_PlayerPos.b)-node_2955));
                float4 _node_356 = tex2D(_PlayerWind,TRANSFORM_TEX(node_5016, _PlayerWind));
                float3 emissive = _node_356.rgb;
/// Final Color:
