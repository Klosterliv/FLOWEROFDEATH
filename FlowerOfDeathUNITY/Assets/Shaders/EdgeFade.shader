    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_6495_ang = node_7869.g;
...
////// Emissive:
                ...
                float3 finalColor = emissive + clamp(((max(0,dot(i.normalDir,lightDirection))*lerp(float3(0,0.4191176,0.03757606),float3(0.9034482,20,0),_Diffuse_var.g)*attenuation*_LightColor0.rgb*_Tint.rgb)*((1.0 - node_4769)*19.0+1.0)),0,10);
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float2 node_8890 = (float2(_posX,_posZ)/100.0);
                float4 node_3482 = tex2Dlod(_WindMap,float4(TRANSFORM_TEX(node_8890, _WindMap),0.0,0));
                float4 node_9176 = _Time + _TimeEditor;
                float node_6495_ang = node_9176.g;
                float node_6495_spd = 1.0;
                float node_6495_cos = cos(node_6495_spd*node_6495_ang);
                float node_6495_sin = sin(node_6495_spd*node_6495_ang);
                float2 node_6495_piv = float2(0.5,0.5);
...
////// Lighting:
                ...
                float node_4769_if_leB = step(node_9898,0.2);
                float node_4769 = lerp((node_4769_if_leA*node_9898)+(node_4769_if_leB*0.0),node_9898,node_4769_if_leA*node_4769_if_leB);
                float3 finalColor = clamp(((max(0,dot(i.normalDir,lightDirection))*lerp(float3(0,0.4191176,0.03757606),float3(0.9034482,20,0),_Diffuse_var.g)*attenuation*_LightColor0.rgb*_Tint.rgb)*((1.0 - node_4769)*19.0+1.0)),0,10);
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float2 node_8890 = (float2(_posX,_posZ)/100.0);
                float4 node_3482 = tex2Dlod(_WindMap,float4(TRANSFORM_TEX(node_8890, _WindMap),0.0,0));
                float4 node_6933 = _Time + _TimeEditor;
                float node_6495_ang = node_6933.g;
                float node_6495_spd = 1.0;
                float node_6495_cos = cos(node_6495_spd*node_6495_ang);
                float node_6495_sin = sin(node_6495_spd*node_6495_ang);
                float2 node_6495_piv = float2(0.5,0.5);
...
/////// Vectors:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_6495_ang = node_1094.g;
                float node_6495_spd = 1.0;
                float node_6495_cos = cos(node_6495_spd*node_6495_ang);
                float node_6495_sin = sin(node_6495_spd*node_6495_ang);
                float2 node_6495_piv = float2(0.5,0.5);
