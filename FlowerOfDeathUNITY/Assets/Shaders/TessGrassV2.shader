...
Shader "Cloisterlife/TessGrassV2" {
    Properties {
        ...
        _Color2 ("Color2", Vector) = (0.02919548,0.06612264,0.7941176,0)
        _Color1 ("Color1", Vector) = (0,0,0,0)
        _minTess ("minTess", Float ) = 0
        _maxTess ("maxTess", Float ) = 100
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float Tessellation(TessVertex v){
                    float node_6758 = lerp(_minTess,_maxTess,(1.0 - (clamp(distance(mul(_Object2World, v.vertex).rgb,_WorldSpaceCameraPos),0.0,_maxdist)/_maxdist)));
                    return node_6758;
                }
